...
export const CATEGORY_CONFIG: Record<string, CategoryConfigEntry> = {
  cleanser: {
    ...
    tableColumns: [
      ...
      { id: "texture", labels: "Texture", width: "col-span-1 text-center" },
  ...
  // TODO: Implement Toner Pads with backend
  toner: {
    category: "Toners",
    specificFilters: [
      {
  ...
  essence: {
    ...
    tableColumns: [
      ...
      { id: "effect", labels: "Effect", width: "col-span-1 text-center" },
      { id: "skinType", labels: "SkinType", width: "col-span-1" },
      { id: "country", labels: "Country", width: "col-span-1 text-center" },
      { id: "rating", labels: "Rating", width: "col-span-1 text-center" },
      { id: "price", labels: "Price", width: "col-span-1 text-right" },
  ...
  moisturizer: {
    ...
    tableColumns: [
      { id: "name", labels: "Product", width: "col-span-5 text-left" },
      { id: "texture", labels: "Texture", width: "col-span-1 text-center" },
      { id: "finish", labels: "Finish", width: "col-span-1 text-center" },
      { id: "skinType", labels: "SkinType", width: "col-span-1" },
      { id: "country", labels: "Country", width: "col-span-1 text-center" },
      { id: "rating", labels: "Rating", width: "col-span-1 text-center" },
      { id: "price", labels: "Price", width: "col-span-1 text-right" },
  ...
  sunscreen: {
    ...
    tableColumns: [
      ...
      { id: "spf", labels: "Spf", width: "col-span-1 text-center" },
      { id: "finish", labels: "Finish", width: "col-span-1 text-center" },
      { id: "filter", labels: "Filter", width: "col-span-1 text-center" },
      { id: "skinType", labels: "skinType", width: "col-span-1" },
      { id: "country", labels: "Country", width: "col-span-1 text-center" },
      { id: "rating", labels: "Rating", width: "col-span-1 text-center" },
      { id: "price", labels: "Price", width: "col-span-1 text-right" },
