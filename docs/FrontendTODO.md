...
1. Profile button dropdown.
   ...
   b. system theme
   c. users routines, almost done, need image / product, need update backend.
   c. saved products ?
   d. sign out, done, fixed error.
...
5. Implement Delete Routine.

6. update builder to implement save modal and title, Done
