  ...
  return (
    <div>
      ...
      >
        ...
        <p>
          ClearUp is a skincare database, where users can learn and build
          routine for skincare. In this website, there are provided tools to
          help you discover new products, track your routine products, and share
          your customized routines with others.
        </p>
        <h2>Why do I need to create an account?</h2>
        <p>
          While anyone can browse public guides and routines, creating an
          account allows you to save and update your routines and be eligible to
          be featured on the guides page. Your account securely stores your
          routine data across your devices.
        </p>
        ...
        <p>
          ...
          following scenarios: Email Verification: A one-time link sent
          immediately after registration to verify you own the email address.
        ...
        <p>
          ...
          personally: lovesakuti@gmail.com.
        </p>
      </InfoArticle>
    </div>
  );
